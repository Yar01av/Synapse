...
class A2C(AgentTraining):
    def __init__(self, gamma=0.99, beta=0.01, lr=0.002, batch_size=8, max_training_steps=1000, desired_avg_reward=500,
                 unfolding_steps=3):
        super().__init__()
        ...
        # Logging related
        self._plotter = SummaryWriter(comment=f"x{self.__class__}")
